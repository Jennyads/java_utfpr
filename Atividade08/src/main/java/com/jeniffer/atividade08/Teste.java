    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (opcao) {
                ...
                case "7" -> {
                    if (bd.getListaPasseio().isEmpty()) {
                        System.out.println("Não há veículos de passeio cadastrados.");
                        break;
                    }
                    String placa = leitura.entDados("Informe a placa do veículo de passeio para excluir: ");
                    boolean removido = bd.removerPasseioPorPlaca(placa);
                    if (removido) {
                        System.out.println("Veículo de passeio removido com sucesso.");
                    } else {
                ...
                case "8" -> {
                    if (bd.getListaCarga().isEmpty()) {
                        System.out.println("Não há veículos de carga cadastrados.");
                        break;
                    }
                    String placa = leitura.entDados("Informe a placa do veículo de carga para excluir: ");
                    boolean removido = bd.removerCargaPorPlaca(placa);
                    if (removido) {
                        System.out.println("Veículo de carga removido com sucesso.");
                    } else {

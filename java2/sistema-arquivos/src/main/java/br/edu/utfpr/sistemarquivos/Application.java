...
public class Application {
    ...
    public static final String ROOT = "C:" + File.separator + "Users" + File.separator + "jenny" +
            File.separator + "OneDrive" + File.separator + "Ambiente de Trabalho" +
            File.separator + "java_utfpr" + File.separator + "java2" + File.separator + "hd";
